...
const MySkills = () => {
  return (
    <div className={style.c}>
      ...
      <section className={style.sectionIncos}>
        <section className={style.sectionIconsAll}>
          <section className={style.sectionIcons}>
            ...
            <p className={style.sectionTitleTec}>HTML</p>
          </section>
          <section className={style.sectionIcons}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p className={style.sectionTitleTec}>CSS</p>
          </section>
          <section className={style.sectionIcons}>
            <svg
              width="57"
            ...
            >
              <g id="icon-javscript">
                <path id="Vector" d="M0.5 56V0H56.5V56H0.5Z" fill="white" />
                <path
                  id="Vector_2"
                  ...
                  fill="black"
                  className={style.svgJavascript}
                />
              </g>
            </svg>
            <p className={style.sectionTitleTec}>JAVASCRIPT</p>
          </section>
          <section className={style.sectionIcons}>
            <svg
              width="62"
            ...
            <p className={style.sectionTitleTec}>REACT</p>
          </section>
          <section className={style.sectionIcons}>
            <svg
              width="56"
        ...
        <section className={style.sectionIconsAll}>
          <section className={style.sectionIcons}>
            ...
            <p className={style.sectionTitleTec}>DOCKER</p>
          </section>
          <section className={style.sectionIcons}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p className={style.sectionTitleTec}>PYTHON</p>
          </section>
        </section>
      </section>
    </div>
